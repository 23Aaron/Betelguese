...
#define AMSVC_SYSTEM_PROFILER       CFSTR("com.apple.mobile.system_profiler")
	...
	/*
	 ...
	 +0	000318e5  55					  pushl		  %ebp
	 +1	000318e6  89e5					  movl		  %esp,%ebp
	 +3	000318e8  83ec08				  subl		  $0x08,%esp
	 +6	000318eb  891c24				  movl		  %ebx,(%esp)
	 +9	000318ee  89742404				  movl		  %esi,0x04(%esp)
	 +13	000318f2  8b7508				  movl		  0x08(%ebp),%esi
	 +16	000318f5  e800000000			  calll		  0x000318fa
	 +21	000318fa  5b					  popl		  %ebx
	 +22	000318fb  807d0c01				  cmpb		  $0x01,0x0c(%ebp)
	 +26	000318ff  750a					  jne		  0x0003190b
	 +28	00031901  31c9					  xorl		  %ecx,%ecx
	 +30	00031903  8d939e7d0300			  leal		  0x00037d9e(%ebx),%edx
	 +36	00031909  eb08					  jmp		  0x00031913
	 +38	0003190b  31c9					  xorl		  %ecx,%ecx
	 +40	0003190d  8d93ae7d0300			  leal		  0x00037dae(%ebx),%edx
	 +46	00031913  89f0					  movl		  %esi,%eax
	 +48	00031915  e875f6ffff			  calll		  0x100030f8f
	 +53	0003191a  85c0					  testl		  %eax,%eax
	 +55	0003191c  7517					  jne		  0x00031935
	 +57	0003191e  8d93be7d0300			  leal		  0x00037dbe(%ebx),%edx
	 +63	00031924  89f0					  movl		  %esi,%eax
	 +65	00031926  8b1c24				  movl		  (%esp),%ebx
	 +68	00031929  8b742404				  movl		  0x04(%esp),%esi
	 +72	0003192d  31c9					  xorl		  %ecx,%ecx
	 +74	0003192f  c9					  leave
	 +75	00031930  e95af6ffff			  jmp		  0x100030f8f
	 +80	00031935  8b1c24				  movl		  (%esp),%ebx
	 +83	00031938  8b742404				  movl		  0x04(%esp),%esi
	 +87	0003193c  c9					  leave
	 +88	0003193d  c3					  ret
	...
	/*
	 void AMRecoveryModeDeviceSendCommandToDevice
	 
	 _AMRecoveryModeDeviceSendCommandToDevice:
	 +0	00031980  55					  pushl		  %ebp
	 +1	00031981  31c9					  xorl		  %ecx,%ecx
	 +3	00031983  89e5					  movl		  %esp,%ebp
	 +5	00031985  8b4508				  movl		  0x08(%ebp),%eax
	 +8	00031988  8b550c				  movl		  0x0c(%ebp),%edx
	 +11	0003198b  c9					  leave
	 +12	0003198c  e9fef5ffff			  jmp		  0x100030f8f
